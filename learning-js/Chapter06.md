...
### 6.3.2 매개변수 해체
[5장](./Chapter05.md#해체-할당)에서 배웠듯, 객체나 배열처럼 매개변수도 변수로 해체할 수 있습니다.
...
- 화살표 함수는 항상 **익명 함수**이고 다른 곳에 전달하려 할 때 가장 유용합니다. [[8장 참조]](./Chapter08.md)
- 일반적인 함수와 달리 객체 생성자로 사용할 수 없고, arguments 변수도 사용할 수 없습니다.[[9장 참조]](./Chapter09.md)
